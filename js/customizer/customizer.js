...
function MultiImageControl(root) {
    ...
    this.store = jQuery('input.multi-images-control-input');
    this.uploadButtton = jQuery('.multi-images-upload');
    this.removeButton = jQuery('.multi-images-remove');
    this.thumbnails = jQuery('ul.thumbnails');
