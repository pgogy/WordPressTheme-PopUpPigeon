...
<?php 
	...
	popuppigeon_tag_cloud(_x("Tag Cloud","tag cloud","pop-up-pigeon"), popuppigeon_posts_content("category", get_cat_id( single_cat_title("",false) )));
	
	popuppigeon_featured_posts_content("category", get_cat_id( single_cat_title("",false)));
