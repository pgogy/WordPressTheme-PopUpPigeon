...
?>
.home <?PHP echo "#post-" . get_the_ID(); ?> div.home-entry:before{
	position: absolute;
    content: '';
    top: 108px;
	left: 0px;
...
<article id="post-<?php the_ID(); ?>" <?php post_class("home-page masonry-entry"); ?>>
	<div class='home-picture' <?PHP echo popuppigeon_get_post_background() ?>>
	</div>
